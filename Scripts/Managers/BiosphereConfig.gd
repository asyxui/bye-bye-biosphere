...
@export var objective_item_id: String = "3"
...
@export_multiline var air_quality_event_description: String = "Industrial activity has pushed the local atmosphere past a critical threshold. Production can continue, but the biosphere is slowly beginning to fail."
